...
export function DitheringShader({
  ...
  const sizeRef = useRef<{ width: number; height: number }>({ width: width || 800, height: height || 800 })
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      if (locations.u_colorFront) context.uniform4fv(locations.u_colorFront, hexToRgba(colorFront, opacity))
  ...
  }, [colorBack, colorFront, shape, type, pxSize, speed, opacity])
